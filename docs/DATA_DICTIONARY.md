...
| Transport | routes, vehicles, staff, enrollments | Routes/enrollments active; extended operations pending |
| HR/payroll | employees, documents, attendance, movements, biometric tables, payroll runs/lines/payments | Employee baseline active; operational completion pending |
